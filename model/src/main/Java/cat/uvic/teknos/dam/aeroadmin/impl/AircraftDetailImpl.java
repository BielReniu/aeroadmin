...
public class AircraftDetailImpl implements AircraftDetail {
    ...
    @Override
    public void setMaxRangeKm(int maxRangeKm) { this.maxRangeKm = maxRangeKm; }

    @Override
    public int getMaxSpeedKmh() { return maxSpeedKmh; }

    @Override
    public void setMaxSpeedKmh(int maxSpeedKmh) { this.maxSpeedKmh = maxSpeedKmh; }

    @Override
    public int getFuelCapacityLiters() { return fuelCapacityLiters; }

    @Override
    public void setFuelCapacityLiters(int fuelCapacityLiters) { this.fuelCapacityLiters = fuelCapacityLiters; }
}